...
namespace Wifi {
    ...
    bool Portal::connectSta_(const String& ssid, const String& pass) {
        WiFi.mode(WIFI_STA);
    ...
    void Portal::registerCommonRoutes_() {
        // Wifi config form
    ...
    void Portal::registerApOnlyRoutes_() {
